...
;
const metadata = {
    title: "NutriSense - Professional Health & Nutrition Platform",
    description: "Comprehensive nutrition management for pregnancy care, athletic performance, and personalized medical guidance",
    generator: "v0.app",
    icons: {
        icon: [
            {

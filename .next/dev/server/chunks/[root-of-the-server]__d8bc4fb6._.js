...
async function updateSession(request) {
    ...
    if ((request.nextUrl.pathname.startsWith("/dashboard") || request.nextUrl.pathname.startsWith("/pregnancy") || request.nextUrl.pathname.startsWith("/athletes") || request.nextUrl.pathname.startsWith("/appointments") || request.nextUrl.pathname.startsWith("/messages") || request.nextUrl.pathname.startsWith("/meal-plans")) && !user) {
